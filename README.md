...
VarjoToolkit は、Varjo Native SDK を使う C++ アプリケーションから、視線、HMD pose / IMU 相当情報、VST カメラ、EyeCamera、EnvironmentCubemap、MR camera property、Varjo timestamp 変換を扱いやすくするための C++17 ライブラリです。
